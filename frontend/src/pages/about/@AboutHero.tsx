...
export function AboutHero() {
	...
	return (
		<div className='relative py-12 text-center lg:text-left sm:py-16'>
			<PawPrint className='absolute -left-4 top-6 size-20 -rotate-12 text-primary/10 sm:size-28 lg:-left-12 lg:top-0 lg:size-40' />

			<div className='relative mx-auto max-w-2xl px-4 lg:mx-0 lg:px-0'>
